...
*/
    ...
    public VenusResponse login(String username, String password) {
      ...
      /*  User findUser = null;
        ...
        ServletUtils.setSessionAttribute(ConstantUser.login_user, user.getUserId());
        return new VenusResponse(200, "登录成功!", user);
    ...
    public VenusResponse getUser() {
        User lg = UserUtils.getUser("1");
        return new VenusResponse(VenusResponseHttpCode.OK, lg);
    }
